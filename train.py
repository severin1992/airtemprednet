'''
Train PredNet on netCDF sequences
'''
...
weights_file = os.path.join(WEIGHTS_DIR, 'prednet_netCDF_weights.hdf5')  # where weights will be saved
...
# Training parameters
nb_epoch = 150 #original: 150; for all tests so far set to 100; t2onlyMax: 150
batch_size = 4
