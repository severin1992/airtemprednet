...
if __name__ == '__main__':
    ...
    for w_tag in ['', '-Lall', '-extrapfinetuned']:
        ...
        convert_model_to_keras2(old_dir + 'prednet_netCDF_model' + m_tag + '.json',
                                old_dir + 'prednet_netCDF_weights' + w_tag + '.hdf5',
                                new_dir + 'prednet_netCDF_model' + m_tag + '.json',
                                new_dir + 'prednet_netCDF_weights' + w_tag + '.hdf5')
